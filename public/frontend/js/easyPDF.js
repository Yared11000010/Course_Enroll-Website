document.addEventListener('DOMContentLoaded', function() {
    // Find all anchor elements within the PDF dialog
    var links = document.querySelectorAll('#pdfDialog');
    // Iterate over each link and add event listener to prevent right-click
...
function easyPDF(_base64, _title) {
	...
	var dialog = '<div id="pdfDialog"  style="width:1200px;"  title="'+_title+'">'+
