            ...
            <div class="card-body">
                <form method="POST" action="{{ route('update-student-say') }}" enctype="multipart/form-data">
                 ...
                 <div class="row">
                  <div class="col-sm-10">
                    <!-- text input -->
                    <input type="hidden" name="id" value="{{ $testmony->id }}">
                    <div class="form-group">
                        <label for="name" class="form-label">Student Name</label>
                        <input type="text" class="form-control" id="name" value="{{ $testmony->name }}" name="name"
                  ...
                  <div class="row">
                      <div class="col-sm-10">
                         <div class="form-group">
                           ...
                           <input type="text" class="form-control" value="{{ $testmony->job }}" name="job" id="" placeholder="Enter Jobs">
                         </div>
                      </div>
                    </div>
