...
$count_pdf_order=PdfOrder::where('user_id',Auth::user()->id)->count();
$count= $count_order +  $count_pdf_order;
}else
{
$count =0 ;
}
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                            <div class="header-contact-info d-flex">
                                <div class="header-contact header-contact-phone">
                                    ...
                                    <p class="phone-number">+251911262107</p>
                                </div>
                                <div class="header-contact header-contact-email">
                                    <span class="ti-email"></span>
                                    <p class="email-name">Atsbehateklu166@Gmail.com</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="header-social-icon-list">
                                <ul>
                                    <li><a href="https://www.facebook.com/SayzanaRim" target="_blank">
                                        <svg id='Facebook_24' width='15' height='15' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'><rect width='24' height='24' stroke='none' fill='#000000' opacity='0'/>
                                            <g transform="matrix(1 0 0 1 12 12)" >
                                            <path style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(255, 255, 255); fill-rule: nonzero; opacity: 1;" transform=" translate(-12, -11.95)" d="M 12 2 C 6.477 2 2 6.477 2 12 C 2 17.012999999999998 5.693 21.153 10.505 21.875999999999998 L 10.505 14.65 L 8.031 14.65 L 8.031 12.021 L 10.505 12.021 L 10.505 10.272 C 10.505 7.376 11.916 6.105 14.323 6.105 C 15.476 6.105 16.085 6.19 16.374000000000002 6.229 L 16.374000000000002 8.523 L 14.732000000000003 8.523 C 13.710000000000003 8.523 13.353000000000003 9.491999999999999 13.353000000000003 10.584 L 13.353000000000003 12.020999999999999 L 16.348000000000003 12.020999999999999 L 15.942000000000002 14.649999999999999 L 13.354000000000003 14.649999999999999 L 13.354000000000003 21.897 C 18.235 21.236 22 17.062 22 12 C 22 6.477 17.523 2 12 2 z" stroke-linecap="round" />
                                            </g>
                                        </svg>
                                    </a></li>
                                    <li><a href="https://youtube.com/@sayzanarim2437?si=ymq7fwICZjjhvzhD" target="_blank">
                                        <svg id='YouTube_24' width='15' height='15' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'><rect width='24' height='24' stroke='none' fill='#000000' opacity='0'/>
                                    ...
                                    <li>
                                        <a href="https://www.linkedin.com/in/atsbeha-teklu-5294aaa1?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">
                                            <svg id='LinkedIn_24' width='15' height='15' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'><rect width='24' height='24' stroke='none' fill='#000000' opacity='0'/>
                                    ...
                                    <li>
                                        <a href="https://t.me/say_1act" target="_blank">
                                            <svg id='Telegram_App_24' width='15' height='15' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'><rect width='24' height='24' stroke='none' fill='#000000' opacity='0'/>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-10 col-lg-10 col-md-6 col-6">
                            <div class="header-bottom-icon f-right">
                                <ul>
                                    <li class="shopping-cart"><a href="{{ route('my-learn') }}"><span class="ti-shopping-cart"></span>
                                            <span class="shopping-counter">
                                              {{ $count }}
                                             </span>
                                        </a></li>
                                </ul>
                            ...
                            <div class="main-menu f-right">
                                <nav id="mobile-menu" style="display: block;">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#about"> <span class="ti-book"></span> &nbsp; Course </a>
                                            <ul class="submenu">
                                                <li>
                                                    <a href="{{ route('courses') }}">Paid Courses</a>

                                                </li>

                                                <li>
                                                    <a href="{{ route('free-courses') }}">Free Course</a>

                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#about"> <span class="ti-shopping-cart "></span> &nbsp; SHOP </a>
                                            <ul class="submenu">
                                                <li>
                                                    <a href="{{ route('shop') }}">Paid PDF</a>

                                                </li>

                                                <li>
                                                    <a href="{{ route('free-pdf') }}">Free PDF</a>
                                        ...
                                        <li>
                                            <a href="{{ route('consltation') }}">Consult</a>
                                        ...
                                        <li>
                                            ...
                                            <ul class="submenu">
                                                <li>
                                                    <a href="{{ route('my-learn') }}">My Courses</a>

                                                </li>

                                                <li>
                                                    <a href="{{ route('my-pdf') }}">MY PDF</a>
                                        ...
                                        <li>
                                            ...
                                            {{-- <a href="{{ route('user-logout') }}"> <span class="ti-account "></span> &nbsp; LOGOUT</a> --}}
                                        </li>
                                        @else
                                        <li>
                                            <a href="#about"> <span class="ti-user "></span> &nbsp; LOGIN / REGISTER</a>
                                            <ul class="submenu">
                                                <li>
